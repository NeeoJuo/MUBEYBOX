...
BASE_PACKAGES="$BASE_PACKAGES nano"
BASE_PACKAGES="$BASE_PACKAGES parted"
...
mkdir -p $OUTPUT_DIR
make image PROFILE=generic PACKAGES="$PACKAGES"  FILES=files ROOTFS_PARTSIZE=4096 BIN_DIR=$OUTPUT_DIR
ls -lah $OUTPUT_DIR
